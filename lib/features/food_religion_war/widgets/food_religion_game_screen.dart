...
enum _ArenaHaptic { selection, light, medium }

/// Arena haptics are a phone-only accent, and a player who asked the system for
/// reduced motion gets no incidental feedback at all — the same rule the arena
/// already applies to its animations.
void _playArenaHaptic(BuildContext context, _ArenaHaptic haptic) {
  ...
  switch (haptic) {
    case _ArenaHaptic.selection:
      HapticFeedback.selectionClick();
    case _ArenaHaptic.light:
      HapticFeedback.lightImpact();
    case _ArenaHaptic.medium:
...
class _FoodReligionGameScreenState extends State<FoodReligionGameScreen> {
  ...
  void _drawDefense() {
    _playArenaHaptic(context, _ArenaHaptic.light);
  ...
  void _handleSessionChanged() {
    if (_session.stage != _lastFeedbackStage) {
      ...
      if (_session.stage == FoodReligionGameStage.result && mounted) {
        _playArenaHaptic(context, _ArenaHaptic.medium);
      }
    }
                ...
                _FaithCard(
                  ...
                  onTap:
                      session.isSelectionLocked
                          ? null
                          : () {
                            _playArenaHaptic(context, _ArenaHaptic.selection);
